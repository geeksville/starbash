...
class TestProcessedTargetStages:
    ...
    def test_set_default_stages_excludes_by_default(self, mock_processing_like, temp_processing_dir):
    ...
    def test_set_default_stages_preserves_existing_exclusions(self, mock_processing_like, temp_processing_dir):
        ...
        with patch("starbash.processed_target.toml_from_template") as mock_template, \
            ...
            def mock_get(*args, **kwargs):
                if args[0] == "stages":
                    return {
                        "excluded": [],
                        "used": [CommentedString("stage1", None)]
                    }
                return {}
...
class TestProcessedTargetCleanup:
    ...
    def test_cleanup_processing_dir_preserves_named(self, mock_processing_like, temp_processing_dir):
