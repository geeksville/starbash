...
class TestDwarf3HeaderExtension:
    ...
    def test_cali_frame_bias(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/bias/cam_0/bias_gain_2_bin_1.fits"
        )
    ...
    def test_cali_frame_bias_cam1(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/bias/cam_1/bias_gain_2_bin_1.fits"
        )
    ...
    def test_cali_frame_dark(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/dark/cam_0/dark_exp_60.000000_gain_60_bin_1_20C_stack_8.fits"
        )
    ...
    def test_cali_frame_flat_vis(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/flat/cam_0/flat_gain_2_bin_1_ir_0.fits"
        )
    ...
    def test_cali_frame_flat_astro(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/flat/cam_0/flat_gain_2_bin_1_ir_1.fits"
        )
    ...
    def test_cali_frame_flat_duo(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/flat/cam_0/flat_gain_2_bin_1_ir_2.fits"
        )
    ...
    def test_dwarf_dark(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/DWARF_DARK/tele_exp_60_gain_60_bin_1_2025-10-20-03-20-10-952/raw_60s_60_0002_20251020-032310186_20C.fits"
        )
    ...
    def test_light_frame(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/IC 434 Horsehead Nebula/DWARF_RAW_TELE_IC 434_EXP_60_GAIN_60_2025-10-18-04-51-22-420/IC 434_60s60_Astro_20251018-045926401_16C.fits"
        )
    ...
    def test_dwarf_dark_different_exposure(self, setup_test_environment):
        ...
        full_path = Path(
            "/workspaces/starbash/test-data/inflated/dwarf3/DWARF_DARK/tele_exp_15_gain_130_bin_1_2025-10-31-05-42-52-480/raw_15s_130_0000_20251031-054306711_16C.fits"
        )
    ...
    def test_cali_frame_dark_various_exposures(self, setup_test_environment):
        ...
        for filename, expected_exp, expected_gain in test_cases:
            ...
            full_path = Path(
                f"/workspaces/starbash/test-data/inflated/dwarf3/CALI_FRAME/dark/cam_0/{filename}"
            )
