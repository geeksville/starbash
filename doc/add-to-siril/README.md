...
* (Not required for the proof-of-concept but possibly useful for info@veralux.space) I added a [little function](https://github.com/geeksville/siril-scripts/blob/49ad1213d0e13e823e4becd279849690dd48770c/processing/VeraLux_HyperMetric_Stretch.py#L1419-L1433) to automate the mapping from FITS camera name metadata to the existing menu he usually offers.
